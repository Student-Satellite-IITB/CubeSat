...
Ir = np.array([0, 0, 0]) # initial control variable/armature currents (A)
...
for i in range(300):
    ...
    Ir = co_armature_current(q, q_command, w, w_command, co_constants.H, omega_n, zeta, T, np.diag(np.array([co_constants.I_1, co_constants.I_2, co_constants.I_3])), co_constants.KR, sigma_integrate)
    w_new = co_propagating_w_i(w[0], w[1], w[2], co_constants.I_1, co_constants.I_2, co_constants.I_3, co_constants.KR, Ir[0], Ir[1], Ir[2], co_constants.BR, W[0], W[1], W[2], co_constants.I_DASH, co_constants.MASS, co_constants.B, co_constants.H)
    W_new = np.array([co_propagating_w_rw_i(co_constants.I_DASH, co_constants.KR, co_constants.BR, Ir[0], W[0], w_new[0], w[0], co_constants.H),
                      co_propagating_w_rw_i(co_constants.I_DASH, co_constants.KR, co_constants.BR, Ir[1], W[1], w_new[1], w[1], co_constants.H),
                      co_propagating_w_rw_i(co_constants.I_DASH, co_constants.KR, co_constants.BR, Ir[2], W[2], w_new[2], w[2], co_constants.H)])
